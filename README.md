...
**État actuel : Phase 1 — socle technique.**
Le projet démarre, compile et se construit. Le gameplay n'existe pas encore :
un cube qui tourne sert de témoin de bon fonctionnement.
...
- [ ] **Phase 2** — prototype FPS : marcher, regarder, collisions, interagir
